...
public:
    ...
    pthread_mutex_t search_flag_mutex;
...
private:
    ...
    void BuildTree(KD_TREE_NODE **root, int l, int r, PointType *Storage, size_t Storage_size);
    ...
    void consistent(KD_TREE_NODE *root);
...
public:
    ...
    void Build(PointType *point_cloud, size_t size);
